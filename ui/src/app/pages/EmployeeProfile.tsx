...
const translations = {
  'zh-TW': {
    ...
    sections: {
      ...
      documents: '證書及合約',
      visas: 'Visa 資料',
      monthlyBonusNote: 'Briefing、出勤獎金及 Booking 獎金會於「薪資與合規」按月份選擇是否發放；以下只設定預設金額。',
    ...
    specialCommissionRules: {
      ...
      note: '以上兩項會在薪資月結總覽按每月輸入人頭自動計算。',
    },
    payrollBonusNote: '啟用 Sales Bonus 後，可選 Bonus 1、Bonus 2 或自訂 Bonus；自訂 Bonus 可像 Bonus 1 一樣設定多個級距。',
    shopBonusNote: '鋪數係獨立額外項目，按每月 target 達成百分比計算；標準鋪數會用預設級距，自訂鋪數可自行設定級距。實際 target % 會在薪資月結總覽逐月輸入。',
  ...
  'zh-CN': {
    ...
    specialCommissionRules: {
      ...
      telesalesRule2: '41-80 人：HKD 50 / 人',
      telesalesRule3: '80 人以上：HKD 60 / 人',
      note: '以上两项会在薪资月结总览按每月输入人头自动计算。',
    },
    payrollBonusNote: '启用 Sales Bonus 后，可选 Bonus 1、Bonus 2 或自定义 Bonus；自定义 Bonus 可像 Bonus 1 一样设置多个级距。',
    shopBonusNote: '铺数是独立额外项目，按每月 target 达成百分比计算；标准铺数会用预设级距，自定义铺数可自行设置级距。实际 target % 会在薪资月结总览逐月输入。',
    payrollBonusSchemeOptions: {
      bonus_1: 'Bonus 1',
      bonus_2: 'Bonus 2',
      custom: '自定义 Bonus',
