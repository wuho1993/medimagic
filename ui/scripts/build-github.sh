...
# 3b. Copy nested dynamic routes
if [ -f "$OVERLAY_DIR/app/app/people/[id]/page.tsx" ]; then
  cp "$OVERLAY_DIR/app/app/people/[id]/page.tsx" "$UI_DIR/app/app/people/[id]/page.tsx"
fi
