-- Adds fixed-threshold Redeem bonus support for payroll profiles and monthly payroll snapshots.
-- Yan / LY use two independent BAR-style bonuses:
--   Sales volume  >= threshold => fixed Sales bonus amount
--   Redeem volume >= threshold => fixed Redeem bonus amount
...
-- Yan (SF066) and LY (SF164) BAR-style bonus setup.
...
set
  ...
  performance_bonus_rules = '[
    {
      "code": "sales_bar_bonus",
      "name": "Sales BAR Bonus",
      "metric": "sales",
      "enabled": true,
      "tiers": [
    ...
    {
      "code": "redeem_bar_bonus",
      "name": "Redeem BAR Bonus",
      "metric": "redeem",
      "enabled": true,
      "tiers": [
