...
import { fetchPayrollReviewAnswers } from '@/app/app/payroll/actions';
export default function PayrollPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      fetchPayrollReviewAnswers(payrollMonth),
      fetchRollingCommissionAverages(user, payrollMonth),
    ]).then(([employees, commissionTiers, savedRecords, commissionAvg, payrollBonusConfig, attendanceRecords, sys, payrollReviewAnswers, rollingCommissionAverages]) => {
      setData({ employees, commissionTiers, savedRecords, commissionAvg, payrollBonusConfig, attendanceRecords, defaultPackageNoPayHandling: sys.packageNoPayDefaultHandling, payrollReviewAnswers, rollingCommissionAverages });
    }).catch(console.error);
  }, [payrollMonth, user]);
